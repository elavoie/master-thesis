...
specialization example to provide the \kw{dataCache} array. Executing the code
will eventually replace \kw{codeCache0} with the expected method, corresponding
to the second return statement in the \kw{initState} function.
...
\kw{__memoize__} name is updated, \textit{all} caches  be invalidated. This
