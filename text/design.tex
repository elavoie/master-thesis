...
We can do better than that but we will need to wait after the object
representation has been introduced for further optimization gains.  The initial
inspiration for this optimization was drawn from the lazy function definition
pattern as explained by Peter Michaux, in which after the initial setup
performed by a function, a new function without the initialization code can
replace the original function to provide an efficient
